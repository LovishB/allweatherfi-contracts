 ...
 * @dev This contract handles price feeds for Oil (WTI), Gold (XAU), VOO ETF, and LQD Bond ETF
 */
contract AllWeatherPriceOracle {
    IPyth public immutable PYTH;
    
    // Price feed IDs for the 4 assets
    bytes32 public constant OIL_PRICE_FEED_ID = 0x925ca92ff005ae943c158e3563f59698ce7e75c5a8c8dd43303a0a154887b3e6; // USOILSPOT/USD
     ...
     * @return prices Array of current raw Pyth prices [VOO, LQD, Gold, Oil]
     */
    ...
    function getCurrentPrices() public view returns (PythStructs.Price[4] memory prices) {
        ...
        // Get Oil price
        prices[3] = PYTH.getPriceUnsafe(OIL_PRICE_FEED_ID);
     ...
     * @param assetIndex Index of the asset (0=VOO, 1=LQD, 2=Gold, 3=Oil)
